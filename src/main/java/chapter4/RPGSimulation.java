...
public class RPGSimulation {
    ...
    public static void main(String[] args) {
        ...
        Hero klar = new Hero("Klar", 10, 12, 3);
        Hero tyrenni = new Hero("Tyrenni", 6, 6, 6, spellbook);
            ...
            if (player instanceof Hero hero) {
                ...
                if (monster.isAlive()) {
                    ...
                    if (attack >= targetHero.getDefense()) {
                        ...
                        System.out.println(name + " rolls a " + attack + " and hits " +
                                heroName + " for " + damage + " points.");
    ...
    private static List<Object> generatePlayerOrder(List<Hero> heroList, List<Monster> monsterList) {
        ...
        int playerCount = tempHeroList.size() + monsterList.size();
