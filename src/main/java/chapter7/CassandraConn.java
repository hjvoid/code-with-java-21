...
public class CassandraConn {
    ...
    public CassandraConn(String username, String pwd, List<InetSocketAddress> endpointList, String keyspace, String datacenter) {
    ...
    public CassandraConn(String username, String pwd, String secureBundleLocation, String keyspace) {
